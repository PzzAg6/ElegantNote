%!TEX program = xelatex
%使用biblatex,biber编译
%引用样式参见https://sharelatex.psi.ch/learn/Biblatex_citation_styles
%注意引入elegant.cls
\documentclass[cn,hazy,blue,14pt,normal,bibstyle = apa, citestyle = authoryear]{elegantnote}
...
\end{enumerate}
\section{引用测试}
引用两篇文献，这是第一篇\textcite{hadjar_branch-and-cut_2006}，这是第二篇\autocite{irnich_path-reduced_2010}。
